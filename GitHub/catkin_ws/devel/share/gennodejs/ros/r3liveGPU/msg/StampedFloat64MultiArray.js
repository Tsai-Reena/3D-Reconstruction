...
class StampedFloat64MultiArray {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new StampedFloat64MultiArray(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new StampedFloat64MultiArray(null);
...
module.exports = StampedFloat64MultiArray;
