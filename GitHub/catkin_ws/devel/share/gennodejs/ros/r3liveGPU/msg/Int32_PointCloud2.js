...
class Int32_PointCloud2 {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('coeffSel')) {
        this.coeffSel = initObj.coeffSel
      }
      else {
        this.coeffSel = new sensor_msgs.msg.PointCloud2();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [coeffSel]
    bufferOffset = sensor_msgs.msg.PointCloud2.serialize(obj.coeffSel, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Int32_PointCloud2(null);
    ...
    // Deserialize message field [coeffSel]
    data.coeffSel = sensor_msgs.msg.PointCloud2.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += sensor_msgs.msg.PointCloud2.getMessageSize(object.coeffSel);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Int32_PointCloud2(null);
    ...
    if (msg.coeffSel !== undefined) {
      resolved.coeffSel = sensor_msgs.msg.PointCloud2.Resolve(msg.coeffSel)
    }
    else {
      resolved.coeffSel = new sensor_msgs.msg.PointCloud2()
    }
...
module.exports = Int32_PointCloud2;
